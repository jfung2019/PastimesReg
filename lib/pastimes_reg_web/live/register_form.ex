...
#     PastimesRegWeb.RegisterView.render("register_form.html", assigns)
#   end
...
#       |> assign(:changeset, PastimesReg.change_example(%{}))
...
#     changeset = PastimesReg.change_example(params) |> Map.put(:action, :insert)
...
#     changeset = PastimesReg.change_example(params)
...
#          |> redirect(to: Routes.live_path(PastimesRegWeb.Endpoint, PastimesRegWeb.RegisterLive))}
