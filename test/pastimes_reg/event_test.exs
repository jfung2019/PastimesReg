defmodule PastimesReg.EventTest do
  ...
  describe "events" do
    alias PastimesReg.Event.Events
    ...
    test "create_events/1 with valid data creates a events" do
      ...
      assert events.email_adress == "some email_adress"
      assert events.email_notification == true
      assert events.end_date == ~U[2022-01-05 03:13:00Z]
      assert events.event_contact_information == true
    ...
    test "update_events/2 with valid data updates the events" do
      ...
      update_attrs = %{
        ...
        email_adress: "some updated email_adress",
        email_notification: false,
        end_date: ~U[2022-01-06 03:13:00Z],
        event_contact_information: false,
      ...
      assert events.email_adress == "some updated email_adress"
      assert events.email_notification == false
      assert events.end_date == ~U[2022-01-06 03:13:00Z]
      assert events.event_contact_information == false
